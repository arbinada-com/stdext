...
namespace stdext::ioutils
{
    ...
    public:
        text_io_policy_ansi();
        explicit text_io_policy_ansi(const locutils::ansi_encoding encoding);
        explicit text_io_policy_ansi(const char* encoding_name);
        explicit text_io_policy_ansi(const locutils::codecvt_mode_ansi& cvt_mode);
    ...
    public:
        text_io_policy_utf8();
        explicit text_io_policy_utf8(const locutils::codecvt_mode_utf8& cvt_mode);
    ...
    public:
        ...
        explicit text_io_policy_utf16(const locutils::codecvt_mode_utf16& cvt_mode);
    ...
    public:
        text_reader() = delete;
        explicit text_reader(std::wistream& stream);
        text_reader(std::wistream& stream, const text_io_policy& policy);
        explicit text_reader(std::istream& stream);
    ...
    public:
        text_writer() = delete;
        explicit text_writer(std::wostream& stream);
        text_writer(std::wostream& stream, const text_io_policy& policy);
        explicit text_writer(std::ostream& stream);
